#!/bin/bash 
#
# Aria G25/Arietta G25 (debian wheezy) Startup script    (http://www.acmesystems.it/arietta)    
# mike@weaved  
#
...
# only used if /proc/$pid is not available
#                
pidrunning()
{
    pid=$1                                                               
...
start() {                                                                
    ...
    echo -e "Start Weaved service ${service_name}"      
